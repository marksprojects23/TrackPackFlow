...
init(Req, State) ->
    ...
    io:format("~n"),
    % SelfPid = self(),
    ok = erpc:call('tpf@business.tpf.markcuizon.com', gen_server, call, [{global, realstorer}, {storing_package, Package_id, Location_id}, infinity]),    % change it out of infinity later
